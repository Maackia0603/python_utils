...
def parse_source_path(source_path):
    ...
    year = list_source_path[4]  #list_source_path[2]
    month = list_source_path[5][-2:]    #list_source_path[3][-2:]
    ais_type = list_source_path[6]  #list_source_path[4]
    destination_path = '/mnt/d/DATA/Global_AIS/' + year + '/' + month + '/' + ais_type    # D:\DATA\Global_AIS\2024\01\STA
...
if __name__ == "__main__":
    ...
    parser.add_argument('--year_month', type=str, default=202401)
    args = parser.parse_args()
    directory_pos_path = f'/mnt/e/ais_ripe_log/{args.year_month[:4]}/{args.year_month}/POS'
    ...
    for source_path in file_sta_paths:
